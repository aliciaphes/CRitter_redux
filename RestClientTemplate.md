...
In the `src/com.codepath.apps.critter.models`, create the models that represent the key data to be parsed and persisted within your application.
...
Open `src/com.codepath.apps.critter/LoginActivity.java` and configure the `onLoginSuccess` method
